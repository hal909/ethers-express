...
interface TokenControllerMockInterface extends ethers.utils.Interface {
  functions: {
...
export class TokenControllerMock extends Contract {
  ...
  interface: TokenControllerMockInterface;
