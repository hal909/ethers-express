...
interface TrueCurrencyWithGasRefundInterface extends ethers.utils.Interface {
  functions: {
...
export class TrueCurrencyWithGasRefund extends Contract {
  ...
  interface: TrueCurrencyWithGasRefundInterface;
