...
interface TimeOwnedUpgradeabilityProxyInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setExpiration(uint256)": FunctionFragment;
...
export class TimeOwnedUpgradeabilityProxy extends Contract {
  ...
  interface: TimeOwnedUpgradeabilityProxyInterface;
  ...
  functions: {
    ...
    setExpiration(
      newExpirationTime: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
