...
interface MockTrueCurrencyWithDelegateInterface extends ethers.utils.Interface {
  functions: {
...
export class MockTrueCurrencyWithDelegate extends Contract {
  ...
  interface: MockTrueCurrencyWithDelegateInterface;
