...
interface TokenControllerPauseMockInterface extends ethers.utils.Interface {
  functions: {
    ...
    "pausedImplementation()": FunctionFragment;
    ...
    "setPausedImplementation(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "pausedImplementation",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setPausedImplementation",
    values: [string]
  ): string;
...
export class TokenControllerPauseMock extends Contract {
  ...
  interface: TokenControllerPauseMockInterface;
  ...
  functions: {
    ...
    "setPausedImplementation(address)"(
      _pausedToken: string,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
  ...
  pausedImplementation(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    ...
    pausedImplementation(overrides?: CallOverrides): Promise<BigNumber>;
