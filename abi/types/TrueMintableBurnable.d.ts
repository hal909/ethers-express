...
interface TrueMintableBurnableInterface extends ethers.utils.Interface {
  functions: {
...
export class TrueMintableBurnable extends Contract {
  ...
  interface: TrueMintableBurnableInterface;
