...
interface IOwnedUpgradeabilityProxyInterface extends ethers.utils.Interface {
  functions: {
...
export class IOwnedUpgradeabilityProxy extends Contract {
  ...
  interface: IOwnedUpgradeabilityProxyInterface;
