...
interface ProvisionalRegistryInterface extends ethers.utils.Interface {
  functions: {
...
export class ProvisionalRegistry extends Contract {
  ...
  interface: ProvisionalRegistryInterface;
