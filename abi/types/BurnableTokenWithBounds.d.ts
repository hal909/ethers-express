...
interface BurnableTokenWithBoundsInterface extends ethers.utils.Interface {
  functions: {
...
export class BurnableTokenWithBounds extends Contract {
  ...
  interface: BurnableTokenWithBoundsInterface;
