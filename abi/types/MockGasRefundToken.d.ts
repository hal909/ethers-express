...
interface MockGasRefundTokenInterface extends ethers.utils.Interface {
  functions: {
    ...
    "sponsorGas(uint256)": FunctionFragment;
    "sponsorGas2(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "sponsorGas",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "sponsorGas2",
    values: [BigNumberish]
  ): string;
  ...
  decodeFunctionResult(functionFragment: "sponsorGas", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "sponsorGas2",
    data: BytesLike
  ): Result;
...
export class MockGasRefundToken extends Contract {
  ...
  interface: MockGasRefundTokenInterface;
  ...
  callStatic: {
    ...
    sponsorGas(amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    sponsorGas2(amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    sponsorGas(amount: BigNumberish, overrides?: Overrides): Promise<BigNumber>;
